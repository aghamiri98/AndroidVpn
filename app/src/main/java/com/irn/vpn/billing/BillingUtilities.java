...
public class BillingUtilities {
     ...
     * Returns true if premium content should be shown.
     */
    public static boolean isPremiumContent3(@Nullable SubscriptionStatus subscription) {
        return subscription != null &&
                subscription.isEntitlementActive &&
                Constants.PREMIUM_SKU3.equals(subscription.sku) &&
                !subscription.subAlreadyOwned;
    } /**
     * Returns true if premium content should be shown.
     */
    public static boolean isPremiumContent4(@Nullable SubscriptionStatus subscription) {
        return subscription != null &&
                subscription.isEntitlementActive &&
                Constants.PREMIUM_SKU4.equals(subscription.sku) &&
                !subscription.subAlreadyOwned;
    }
