...
public class ServerFunctionsImpl implements ServerFunctions {
    ...
    private static final String PREMIUM_CONTENT_CALLABLE_3 = "content_premium_3";
    private static final String PREMIUM_CONTENT_CALLABLE_4 = "content_premium_4";
    ...
    private MutableLiveData<ContentResource> premiumContent3 = new MutableLiveData<>();
    private MutableLiveData<ContentResource> premiumContent4 = new MutableLiveData<>();
    ...
    public void updatePremiumContent3() {
        incrementRequestCount();
        Log.d(TAG, "Calling: " + PREMIUM_CONTENT_CALLABLE_3);
        firebaseFunctions
                .getHttpsCallable(PREMIUM_CONTENT_CALLABLE_3)
                .call(null)
                .addOnCompleteListener(new OnCompleteListener<HttpsCallableResult>() {
                    @Override
                    public void onComplete(@NonNull Task<HttpsCallableResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            premiumContent3.postValue(content);
                        } else {
                            ServerError error =
                                    serverErrorFromFirebaseException(task.getException());
                            if (error == ServerError.PERMISSION_DENIED) {
    ...
    public void updatePremiumContent4() {
        incrementRequestCount();
        Log.d(TAG, "Calling: " + PREMIUM_CONTENT_CALLABLE_4);
        firebaseFunctions
                .getHttpsCallable(PREMIUM_CONTENT_CALLABLE_4)
                .call(null)
                .addOnCompleteListener(new OnCompleteListener<HttpsCallableResult>() {
                    @Override
                    public void onComplete(@NonNull Task<HttpsCallableResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            premiumContent4.postValue(content);
                        } else {
                            ServerError error =
                                    serverErrorFromFirebaseException(task.getException());
                            if (error == ServerError.PERMISSION_DENIED) {
